...
function [xinew,Atxinew,proju,zeta,ind,fnew,gnew,alp]=...
    Lswolfe_DALMQ(xik,Atxik,fk,gk,dk,Atdk,Amap,b,xsigma,lambda,sigma,mu,lsopts,tol)
...
for iter = 1:maxit
    ...
    [fnew,proju,zeta,ind] = fgrad_DALMQ(xinew,unew,lambda,sigma,mu);
