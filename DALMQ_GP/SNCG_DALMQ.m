...
function [xi,Atxi,proju,negx,Anegx,iter]= SNCG_DALMQ(xi,Atxi,Amap,ATmap,b,OPTIONS,x,pars,lambda,sigma,mu)
...
[fval,proju,zeta] = fgrad_DALMQ(xi,u,pars,lambda,sigma,mu);
...
for iter = 1:maxiter
    ...
    [dir,Atdir,cg_iter] = cg_DALMQ(Amap,ATmap,u,res,pars,lambda,sigma_mu,res,cg_tol,cg_max,n);
    
    [xi,Atxi,proju,u,zeta,fval,gradPsi,lstep]=...
        Lswolfe_DALMQ(xi,Atxi,fval,gradPsi,dir,Atdir,Amap,b,xsigma,pars,lambda,sigma,mu,lsopts,ls_tol);
